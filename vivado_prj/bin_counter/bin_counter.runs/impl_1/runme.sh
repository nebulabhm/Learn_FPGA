...
HD_PWD='H:/my_workshop/learn_fpga/prj/bin_counter/bin_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bin_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bin_counter.tcl -notrace
