...
HD_PWD='H:/my_workshop/learn_fpga/prj/bin_counter/bin_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bin_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bin_counter.tcl
